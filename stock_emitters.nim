...
let
  ...
  prop          = newProperty(twister, 2.7, 2.9)
...
proc summonGreenGlobe*(x: float, y: float): Emitter =
  ...
  result = newEmitter(
    ...
    x            = x, 
    y            = y, 
    speed        = newProperty(twister, 05.00,  0.70), 
    rotation     = newProperty(twister, 10.00, 30.00), 
    size         = newProperty(twister, 00.25, 00.25), 
    color        = prop, 
    alpha        = prop, 
    ttl          = newProperty(twister, 4.0, 10.5), 
...
proc summonSun*(x: float, y: float): Emitter =
  ...
  result = newEmitter(
    ...
    x            = x, 
    y            = y, 
    speed        = newProperty(twister, 2.00, 0.50), 
    rotation     = newProperty(twister, 3.00, 2.00), 
    size         = newProperty(twister, 0.25, 0.25), 
    color        = prop, 
    alpha        = prop, 
    ttl          = newProperty(twister, 50.0, 2.0), 
    maxParticles = maxParticles,
    twister      = twister
  )
...
proc summonExplosion*(x: float, y: float): Emitter =
  ...
  result = newEmitter(
    ...
    y            = y, 
    speed        = newProperty(twister, 2.00, 0.50), 
    rotation     = newProperty(twister, 3.00, 10.00), 
    size         = newProperty(twister, 0.125, 2.0), 
    color        = prop, 
    alpha        = prop, 
    ttl          = newProperty(twister, 80.0, 0.0125), 
    maxParticles = 1000,
    twister      = twister
  ) 
...
proc summonExhaust*(x: float, y: float): Emitter =
  ...
  result = newEmitter(
    ...
    x            = x, 
    y            = y, 
    speed        = newProperty(twister, 7.00, 0.50), 
    rotation     = newProperty(twister, 1.55, 0.0125), 
    size         = newProperty(twister, 0.125, 1.0), 
    color        = prop, 
    alpha        = prop, 
    ttl          = newProperty(twister, 25.0, 0.0125), 
    maxParticles = 2000,
    twister      = twister
  ) 
...
proc summonComet*(x: float, y: float): Emitter =
    ...
    result = newEmitter(
      ...
      x            = x, 
      y            = y, 
      speed        = newProperty(twister, 1.50, 5.1250), 
      rotation     = newProperty(twister, 1.50, 0.0125), 
      size         = newProperty(twister, 0.25, 0.5000), 
      color        = prop, 
      alpha        = prop, 
      ttl          = newProperty(twister, 5.0, 5.0), 
      maxParticles = 1000,
